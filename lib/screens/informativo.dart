...
class Informativo extends StatefulWidget{
  ...
  @override
  _Informativo createState() => _Informativo();
}

class _Informativo extends State<Informativo>{
...
class ImageCard extends StatelessWidget{
  final List<Widget> cards = _Informativo.getCards(20);
